    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcessingUnits", x => x.UnitId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PriceId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PricePerUnitOfMeasure = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    FishTypeId = table.Column<int>(type: "int", nullable: false),
                    EffectiveDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FishPrices", x => x.PriceId);
                    table.ForeignKey(
                        name: "FK_FishPrices_FishTypes_FishTypeId",
